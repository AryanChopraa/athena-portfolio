...
import girl from '../assets/cropped.png'
import './Navbar.css';
    ...
    <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
      ...
      <div class="flex flex-col justify-between xl:w-5/12">
        ...
        <div class="sm:text-center lg:py-12 lg:text-left xl:py-24">
          <p class="mb-4 font-semibold text-white md:mb-6 md:text-lg xl:text-xl">Very proud to introduce</p>

          <h1 class="text-white mb-7 text-2xl font-bold sm:text-5xl md:mb-12 md:text-7xl font-athgame">The Gaming Society of BVCOE Athena</h1>
      ...
      {/* <div class="h-48 overflow-hidden rounded-lg shadow-lg lg:h-auto xl:w-5/12">
        <img src={girl} loading="lazy" alt="Photo by Fakurian Design" class="h-full w-full object-cover object-center" />
      </div>
     */}
    </section>
  </div>
